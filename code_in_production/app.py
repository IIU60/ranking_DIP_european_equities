...
with initial_form:
    n_quantiles = st.number_input('Number of Quantiles:', min_value=2, value=10)
...
rents_dict = af.rank_data(clean_data_dict[selected_ratio],prices_csv_filepath,n_quantiles,return_dict=True)
...
for graph in desired_graphs:
    st.write(graphs_dict[graph](rents_dict))