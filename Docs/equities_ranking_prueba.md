...
4. [La Plataforma](#la-plataforma)
   ...
   4. [Botones de la barra lateral](#botones-de-la-barra-lateral)
      ...
      2. [Create Custom Indicator](#create-custom-indicator)
         1. [La documentación actual:](#la-documentación-actual)
...
![](Images/equities_ranking_images/equities_ranking_images.001.png)
...
<div style="text-align: left; display: grid; grid-template-columns: 1fr 1fr;">
  ...
  <div>
   ...
   <img src=Images/equities_ranking_images/equities_ranking_images.002.png>
...
![](Images/equities_ranking_images/equities_ranking_images.003.png)


## <a name="_toc134438911"></a>Crear Entorno Virtual e Instalar paquetes
1. Abrir una terminal de Anaconda3 (Se llama Anaconda Prompt) ![](Images/equities_ranking_images/equities_ranking_images.004.png)

2. Crear un entorno virtual con la versión de Python y nombre deseados usando el próximo comando:
   1. `conda create -n equities_ranking python=3.10.9` ![](Images/equities_ranking_images/equities_ranking_images.005.png)

   2. al ser preguntado si proceder a instalar paquetes responder que sí con ‘y’

![](Images/equities_ranking_images/equities_ranking_images.006.png)

3. Activar el Entorno Virtual:
   1. `conda activate equities_ranking`
![](Images/equities_ranking_images/equities_ranking_images.007.png)

4. Navegar al directorio del repositorio:
   1. `cd [ruta a la carpeta ‘ranking_DIP_european_equities’]`

![](Images/equities_ranking_images/equities_ranking_images.008.png)
...
![](Images/equities_ranking_images/equities_ranking_images.009.png)
...
![](Images/equities_ranking_images/equities_ranking_images.010.png)
...
![](Images/equities_ranking_images/equities_ranking_images.011.png)
...
![](Images/equities_ranking_images/equities_ranking_images.012.png)
...
![](Images/equities_ranking_images/equities_ranking_images.013.png)
...
![](Images/equities_ranking_images/equities_ranking_images.014.png)
...
![](Images/equities_ranking_images/equities_ranking_images.016.png)
...
![](Images/equities_ranking_images/equities_ranking_images.017.png)
...
![](Images/equities_ranking_images/equities_ranking_images.018.png)

## <a name="_toc134438917"></a>Botones de la barra lateral
### <a name="_toc134438918"></a>Create Multi-factor Indicator
![](Images/equities_ranking_images/equities_ranking_images.019.png)Este apartado permite crear indicadores compuestos por una media de pesos variables de los indicadores disponibles en la lista de datos. Esto puede servir para la descorrelacion indicadores o para optimizar sus rentabilidades, por ejemplo.
...
![](Images/equities_ranking_images/equities_ranking_images.020.png)Las funciones disponibles y su documentación están escondidos en la pestaña ‘Available Functions documentation’. 
...
![](Images/equities_ranking_images/equities_ranking_images.021.png)
...
![](Images/equities_ranking_images/equities_ranking_images.022.png)
...
![](Images/equities_ranking_images/equities_ranking_images.023.png)
